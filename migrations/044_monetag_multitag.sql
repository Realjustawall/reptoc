...
-- Monetag MultiTag (zone 11432701) is loaded once from the document head.
-- Disable the former built-in Adsterra banners so both providers never run on
-- the same page after this deployment. Custom units are left untouched.
